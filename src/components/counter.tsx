...
function Number({ mv, number, height }: NumberProps) {
    ...
    return <motion.span style={{ ...baseStyle, y }} className='font-sans font-bold'>{number}</motion.span>;
}
...
function Digit({ place, value, height, digitStyle }: DigitProps) {
    ...
    if (place === '.') {
        return (
            <span
                className="relative inline-flex items-center justify-center font-sans font-bold"
    ...
    const defaultStyle: React.CSSProperties = {
        ...
        position: 'relative',
        width: '1ch',
        fontVariantNumeric: 'font-sans'
    };

    return (
        <span className="relative inline-flex overflow-hidden font-sans font-bold" style={{ ...defaultStyle, ...digitStyle }}>
