            ...
            <div className={cn(
                ...
                <div className="relative z-10 p-5 group">
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-4 mt-4">
                        {/* COINS */}
                        <div className="relative bg-slate-950/20 backdrop-blur-md border-l border-r border-yellow-500/60 transition-all duration-300">
                            {/* Tech Corners */}
                            ...
                            <div className="relative p-2 flex flex-row items-center justify-start gap-3 bg-yellow-500/5 transition-colors">
                                <div className="flex items-center justify-center p-1.5 rounded bg-yellow-950/30 border border-yellow-500/50 shadow-yellow-500/40 transition-all">
                        ...
                        {/* VIDEOS */}
                        <div className="relative bg-slate-950/20 backdrop-blur-md border-l border-r border-cyan-500/20 hover:border-cyan-500/60 transition-all duration-300">
                            {/* Tech Corners */}
                            ...
                            <div className="relative p-2 flex flex-row items-center justify-start gap-3 bg-cyan-500/5 transition-colors">
                                <div className="flex items-center justify-center p-1.5 rounded bg-cyan-950/30 border border-cyan-500/50  transition-all">
                        ...
                        {/* QUIZZES */}
                        <div className="relative bg-slate-950/20 backdrop-blur-md border-l border-r border-purple-500/60 transition-all duration-300">
                            {/* Tech Corners */}
                            ...
                            <div className="relative p-2 flex flex-row items-center justify-start gap-3 bg-purple-500/5 transition-colors">
                                <div className="flex items-center justify-center p-1.5 rounded bg-purple-950/30 border border-purple-500/50 transition-all">
                        ...
                        {/* Badges */}
                        <div className=" relative bg-slate-950/20 backdrop-blur-md border-l border-r border-emerald-500/60 transition-all duration-300">
                            {/* Tech Corners */}
                            ...
                            <HoverCard>
                                <HoverCardTrigger asChild>
                                    <div className="relative p-2 flex flex-row items-center justify-start gap-3 bg-emerald-500/5 transition-colors">
                                        <div className="flex items-center justify-center p-1.5 rounded bg-emerald-950/30 border border-emerald-500/50 transition-all">
                                ...
                                <HoverCardContent className="w-48 h-40 p-0 border border-emerald-500/20 rounded-none" align="end">
