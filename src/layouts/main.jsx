...
export default function MainLayout() {
    return (
        <>
            <main className="relative w-full flex items-center justify-center px-4 sm:px-6 md:px-8 overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    <div className="flex flex-col space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-right-6 duration-700">
                        ...
                        <div className="w-full flex justify-end">
                            <Link
                                to="/courses"
                                className="inline-flex items-center justify-end px-6 py-3 rounded-xl
                          border-2 border-primary text-primary font-bold
                          hover:bg-primary hover:text-white
                          hover:shadow-lg hover:shadow-primary/40
                          transition-all duration-200 w-fit group"
                            >
                                <span className="mr-2 group-hover:translate-x-1 transition-transform">&gt;</span> Initialize Mission
                            </Link>
                        </div>
...
// import ShowAvatar from "@/components/avatar/avatar-show"
// import { Button } from "@/components/ui/button"
// import { Terminal, Shield, Zap, Target } from "lucide-react"
// import { Link } from "react-router-dom"
...
// export default function MainLayout() {
//     return (
//         // <ShowAvatar className="w-full h-full" />
//         // <main className="w-full h-screen grid grid-cols-1 lg:grid-cols-2 overflow-hidden bg-[#130f30]">
//         //     <div className="relative flex items-center justify-center p-8 lg:p-12 order-2 lg:order-1 z-10">
//         //         <div className="flex flex-col space-y-6 sm:space-y-8 max-w-xl w-full animate-in fade-in slide-in-from-left-6 duration-700">
//         //             <div className="space-y-2">
//         //                 <div className="flex items-center space-x-2 text-primary">
//         //                     <Shield className="w-4 h-4 sm:w-5 sm:h-5" />
//         //                     <span className="text-[10px] sm:text-xs font-mono uppercase tracking-[0.3em]">
...
//         //                 <h1 className="text-3xl sm:text-4xl md:text-5xl font-sans font-black uppercase leading-none text-white">
//         //                     Welcome to <span className="text-primary italic">HUNARHO</span>
//         //                 </h1>
...
//         //             <div className="bg-muted/10 border-l-4 border-primary p-4 sm:p-6 backdrop-blur-sm space-y-4 relative overflow-hidden rounded-r-lg">
//         //                 <Terminal className="absolute top-3 right-3 w-12 h-12 opacity-10 text-white" />
...
//         //     <div className="relative w-full h-[50vh] lg:h-full order-1 lg:order-2">
//         //         <ShowAvatar className="w-full h-full" />

//         //         <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-[#130f30]/0 via-[#130f30]/0 to-[#130f30] lg:bg-gradient-to-l lg:from-[#130f30]/0 lg:via-[#130f30]/0 lg:to-[#130f30] opacity-50" />
//         //     </div>
//         // </main>
//     )
// }
